...
- The isolated QA blocker was resolved after merging assets and renderer into `main`; `npm run test:e2e -- little-alex-physics.spec.ts` passed with 9 tests and captured screenshots.

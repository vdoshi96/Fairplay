...
- [ ] **Step 2: Record subagent findings**
...
**Files:**
- Create: `src/server/ai/generated-ui-asset-prompts.ts`
...
- [ ] **Step 3: Implement specs and prompts**
...
- [ ] **Step 1: Dry-run prompts**

Run: `npm run assets:generate-ui -- --dry-run --output-dir=/tmp/fairplay-generated-ui-dry-run`

- [ ] **Step 2: Generate through Vercel production env**

Run: `npx --yes vercel env run -e production -- npm run assets:generate-ui -- --output-dir=public/assets/fairplay/generated-ui`

- [ ] **Step 3: Inspect dimensions**

Run: `sips -g pixelWidth -g pixelHeight public/assets/fairplay/generated-ui/*.png`

- [ ] **Step 4: Reject or regenerate broken assets**
...
Start the dev server and visually inspect login, crash course, library, load map, radar, and check-ins at desktop and mobile widths.
